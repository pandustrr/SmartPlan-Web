...
function LandingPage({ isDarkMode, toggleDarkMode }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-green-50 dark:from-gray-900 dark:to-gray-800">
      {/* Navigation */}
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                to="/register"
                className="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg transition-all duration-200 font-medium text-lg inline-flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 dark:bg-green-500 dark:hover:bg-green-600"
              >
              ...
              <Link
                to="#features"
                className="border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 px-8 py-4 rounded-lg hover:border-green-600 dark:hover:border-green-400 hover:text-green-600 dark:hover:text-green-400 transition-all duration-200 font-medium text-lg hover:shadow-lg"
              >
                Pelajari Fitur
              </Link>
            </div>
      ...
      {/* Features Section */}
      <section id="features" className="py-20 px-6 bg-white dark:bg-gray-800/50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="bg-gray-50 dark:bg-gray-700/50 p-8 rounded-2xl hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-600 hover:border-green-200 dark:hover:border-green-800 group hover:bg-white dark:hover:bg-gray-700"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, index) => {
              ...
              return (
                <div 
                  key={index}
                  className="text-center group bg-white dark:bg-gray-800 p-6 rounded-2xl hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700"
                >
      ...
      <section className="py-20 px-6 bg-white dark:bg-gray-800/50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-gray-700/50 p-8 rounded-2xl border border-gray-200 dark:border-gray-600 hover:shadow-xl transition-all duration-300">
      ...
      <section id="contact" className="py-20 px-6 bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-700 dark:to-emerald-700">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-green-100 dark:text-green-200 text-xl mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="bg-white text-green-600 px-8 py-4 rounded-lg hover:bg-gray-100 transition-all duration-200 font-bold text-lg inline-flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 dark:bg-white dark:text-green-700 dark:hover:bg-gray-200"
            >
            ...
            <Link
              to="/login"
              className="border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white hover:text-green-600 transition-all duration-200 font-bold text-lg dark:border-white dark:hover:bg-white dark:hover:text-green-700"
            >
              Masuk ke Akun
            </Link>
          </div>
          <p className="text-green-200 dark:text-green-300 mt-4 text-sm">
