  ...
  const features = [
    {
      ...
      shortDesc: "Dashboard analytics real-time dengan insight mendalam untuk keputusan bisnis yang tepat",
    ...
    },
    {
      ...
      shortDesc: "Kelola cash flow, track pendapatan & pengeluaran, dan optimalkan profit dengan sistem otomatis",
    ...
    },
    {
      ...
      shortDesc: "Prediksi penjualan, revenue, dan tren bisnis 6-12 bulan ke depan dengan akurasi 90%+",
    ...
    },
    {
      ...
      shortDesc: "Generate business plan, financial report, dan presentation deck dalam hitungan menit",
    ...
    },
    {
      ...
      shortDesc: "Tools lengkap untuk menyusun strategi bisnis, set goals, dan track KPI dengan sistematis",
    ...
    },
    {
      ...
      shortDesc: "Dapatkan passive income hingga 17% komisi dari setiap referral yang berhasil",
